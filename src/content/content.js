...
export const PROJECTS = [
  ...
  //       "useEffect",
  //     ],
  //     serverSideTech: "None (currently uses fake JSON data)",
  //     databaseTech: "None (currently uses fake JSON data)",
  //     authenticationTech: "Firebase (user authentication, conditional access)",
  //     keyFeatures: [
